...
def show_detection(im_ms, cloud_mask, im_labels, shoreline,image_epsg, georef,
    ...
    # ax2.legend(handles=[orange_patch,white_patch,blue_patch, black_line],               bbox_to_anchor=(1, 0.5), fontsize=10)
...
#    ax3.set_anchor('W')
    ...
    if settings['save_figure'] and not skip_image:
        fig.savefig(os.path.join(filepath, date + '_' + satname + '.png'), dpi=150)
